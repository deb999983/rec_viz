...
def execute(input_file_name: str, output_file_name:str, func_name: str):
    ...
    tracer.run(os.path.join(code_path, os.path.join(code_path, input_file_name)))
    return tracer.save_output(os.path.join(output_path, output_file_name))
...
if __name__ == "__main__":
    ...
    execute(input_file_name, output_file_name, func_name)
